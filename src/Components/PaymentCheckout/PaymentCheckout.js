      ...
      <form>
        <div className={style.method}>
          ...
          <div className={style.button_container}>
            <div className={style.button_checkout}>
              <BsCreditCard />
              Cartão de Credito
            </div>
            <div className={style.button_checkout}>
        ...
        <div className={style.name}>
          ...
          <input type="text" placeholder="Jonh Carter" />
        </div>

        <div className={style.card_number}>
          <p>Numero do Cartão:</p>

          <input type="number" placeholder="●●●● ●●●● ●●●● 2472" />
        </div>
        ...
        <Button text="Check Out" icon="" to="/home" style={styles} />
      </form>
    </div>
  );
}
